...
This is done with an Obsidian plugin called **[obsidian-shellcommands](https://github.com/Taitava/obsidian-shellcommands)** that can call bash scripts using a hotkey. The bash script I have setup will copy all the files I wanna post over to my Hugo project. It will also find all the image links from these posts and transfer them over.
